...
object ItemAnimation {
    ...
    private fun animateBottomUp(view : View, pos : Int) {
        ...
        val animatorTranslateY : ObjectAnimator =
            ObjectAnimator.ofFloat(view, "translationY", (if (notFirstItem) 800 else 500).toFloat(), 0f)
    ...
    private fun animateFadeIn(view : View, pos : Int) {
        ...
        animatorAlpha.startDelay =
            if (notFirstItem) DURATION_IN_FADE_ID / 2 else position * DURATION_IN_FADE_ID / 4
    ...
    private fun animateLeftRight(view : View, pos : Int) {
        ...
        animatorTranslateY.duration = (if (notFirstItem) 2 else 1) * DURATION_IN_LEFT_RIGHT
        animatorSet.playTogether(animatorTranslateY, animatorAlpha)
        animatorSet.start()
    }
